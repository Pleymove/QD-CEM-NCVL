...
GC_COLUMNS = [
    ...
    ("longueur", "Longueur source (ml)"),
    ("longueur_gc_totale", "Longueur GC totale (m)"),
    ("longueur_couverte", "Longueur couverte optique (m)"),
    ("ml_restant_optique", "ML restant optique (m)"),
